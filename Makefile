...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  cola_sal.o queue.o register.o ruteo_ip.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
cola_sal.o: /cygdrive/C/eclipse/workspace/test/cola_sal.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
queue.o: /cygdrive/C/eclipse/workspace/test/queue.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/test/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
ruteo_ip.o: /cygdrive/C/eclipse/workspace/test/ruteo_ip.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
cola_sal.o: /cygdrive/C/eclipse/workspace/test/cola_sal.cpp \
 /cygdrive/C/eclipse/workspace/test/cola_sal.h \
...
queue.o: /cygdrive/C/eclipse/workspace/test/queue.cpp \
 /cygdrive/C/eclipse/workspace/test/queue.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
register.o: /cygdrive/C/eclipse/workspace/test/register.cpp \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/workspace/test/cola_sal.h \
 /cygdrive/C/eclipse/workspace/test/ruteo_ip.h
ruteo_ip.o: /cygdrive/C/eclipse/workspace/test/ruteo_ip.cpp \
 /cygdrive/C/eclipse/workspace/test/ruteo_ip.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
